...
func (m *FailureSet) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.Failure = append(m.Failure, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *ConformanceRequest) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Payload = &ConformanceRequest_JsonPayload{JsonPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RequestedOutputFormat", wireType)
		...
		case 4:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.MessageType = *(*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TestCategory", wireType)
		...
		case 6:
			...
			if err := m.JspbEncodingOptions.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Payload = &ConformanceRequest_JspbPayload{JspbPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TextPayload", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Payload = &ConformanceRequest_TextPayload{TextPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrintUnknownFields", wireType)
...
func (m *ConformanceResponse) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_ParseError{ParseError: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RuntimeError", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_RuntimeError{RuntimeError: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProtobufPayload", wireType)
		...
		case 4:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_JsonPayload{JsonPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Skipped", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_Skipped{Skipped: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SerializeError", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_SerializeError{SerializeError: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JspbPayload", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_JspbPayload{JspbPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TextPayload", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Result = &ConformanceResponse_TextPayload{TextPayload: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *JspbEncodingConfig) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
