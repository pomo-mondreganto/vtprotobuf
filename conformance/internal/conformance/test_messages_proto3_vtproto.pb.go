...
func (m *TestAllTypesProto3_NestedMessage) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestAllTypesProto3) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 113:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.OneofField = &TestAllTypesProto3_OneofString{OneofString: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 114:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OneofBytes", wireType)
...
func (m *ForeignMessage) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *NullHypothesisProto3) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *EnumOnlyProto3) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
