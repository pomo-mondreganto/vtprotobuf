...
func (m *TestAllTypesProto2_NestedMessage) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 2:
			...
			if err := m.Corecursive.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TestAllTypesProto2_Data) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestAllTypesProto2_MessageSetCorrect) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestAllTypesProto2_MessageSetCorrectExtension1) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 25:
			...
			m.Str = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *TestAllTypesProto2_MessageSetCorrectExtension2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *TestAllTypesProto2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 18:
			...
			if err := m.OptionalNestedMessage.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 19:
			...
			if err := m.OptionalForeignMessage.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 21:
		...
		case 24:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.OptionalStringPiece = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OptionalCord", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.OptionalCord = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RecursiveMessage", wireType)
			...
			if err := m.RecursiveMessage.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 31:
		...
		case 48:
			...
			m.RepeatedNestedMessage = append(m.RepeatedNestedMessage, &TestAllTypesProto2_NestedMessage{})
			if err := m.RepeatedNestedMessage[len(m.RepeatedNestedMessage)-1].UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 49:
			...
			m.RepeatedForeignMessage = append(m.RepeatedForeignMessage, &ForeignMessageProto2{})
			if err := m.RepeatedForeignMessage[len(m.RepeatedForeignMessage)-1].UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 51:
		...
		case 54:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.RepeatedStringPiece = append(m.RepeatedStringPiece, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		case 55:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RepeatedCord", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.RepeatedCord = append(m.RepeatedCord, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		case 56:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MapInt32Int32", wireType)
		...
		case 71:
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					mapvalue = &TestAllTypesProto2_NestedMessage{}
					if err := mapvalue.UnmarshalAliasVT(dAtA[iNdEx:postmsgIndex]); err != nil {
						return err
					}
					iNdEx = postmsgIndex
				} else {
		...
		case 112:
			...
			if oneof, ok := m.OneofField.(*TestAllTypesProto2_OneofNestedMessage); ok {
				if err := oneof.OneofNestedMessage.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
			} else {
				v := &TestAllTypesProto2_NestedMessage{}
				if err := v.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
					return err
				}
				m.OneofField = &TestAllTypesProto2_OneofNestedMessage{OneofNestedMessage: v}
			}
		...
		case 113:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.OneofField = &TestAllTypesProto2_OneofString{OneofString: *(*string)(unsafe.Pointer(&sliceData))}
			iNdEx = postIndex
		case 114:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OneofBytes", wireType)
		...
		case 201:
			...
			for {
				...
				groupWireType := int(wire & 0x7)
				if groupWireType == 4 {
					if err := m.Data.UnmarshalAliasVT(dAtA[groupStart:maybeGroupEnd]); err != nil {
						return err
					}
					break
				}
		...
		case 254:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.DefaultString = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DefaultBytes", wireType)
...
func (m *ForeignMessageProto2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *UnknownToTestAllTypes_OptionalGroup) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *UnknownToTestAllTypes) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1003:
			...
			if err := m.NestedMessage.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 1004:
			...
			for {
				...
				groupWireType := int(wire & 0x7)
				if groupWireType == 4 {
					if err := m.Optionalgroup.UnmarshalAliasVT(dAtA[groupStart:maybeGroupEnd]); err != nil {
						return err
					}
					break
				}
...
func (m *NullHypothesisProto2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *EnumOnlyProto2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
...
func (m *OneStringProto2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.Data = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
