...
func (m *Test1) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			m.Sl = append(m.Sl, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *Test2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 1:
			...
			if err := m.Sl[len(m.Sl)-1].UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Slice2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		case 3:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.C = append(m.C, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field D", wireType)
			...
			if err := m.D.UnmarshalAliasVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.E = *(*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field F", wireType)
...
func (m *Element2) UnmarshalAliasVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
