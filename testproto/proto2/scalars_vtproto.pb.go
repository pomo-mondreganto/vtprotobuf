...
func (m *DoubleMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *FloatMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Int32Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Int64Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Uint32Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Uint64Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Sint32Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Sint64Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Fixed32Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Fixed64Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Sfixed32Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *Sfixed64Message) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *BoolMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *StringMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		case 1:
			...
			m.RequiredField = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
			hasFields[0] |= uint64(0x00000001)
		case 2:
			if wireType != 2 {
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.OptionalField = (*string)(unsafe.Pointer(&sliceData))
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RepeatedField", wireType)
			...
			sliceData := dAtA[iNdEx:postIndex]
			m.RepeatedField = append(m.RepeatedField, *(*string)(unsafe.Pointer(&sliceData)))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skip(dAtA[iNdEx:])
...
func (m *BytesMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
...
func (m *EnumMessage) UnmarshalAliasVT(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
